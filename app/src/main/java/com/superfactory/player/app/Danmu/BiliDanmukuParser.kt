...
class BiliDanmukuParser : BaseDanmakuParser() {
    ...
    protected var mDispScaleX: Float = 0.toFloat()
    protected var mDispScaleY: Float = 0.toFloat()
        ...
        override fun startElement(uri: String, localName: String, qName: String, attributes: Attributes) {
            ...
            if (tagName == "d") {
                ...
                if (values.isNotEmpty()) {
                    ...
                    val color = (-0x1000000 or java.lang.Long.parseLong(values[3]).toInt() and -0x1).toInt() // 颜色
            ...
            if (item != null) {
                ...
                if (item!!.type == BaseDanmaku.TYPE_SPECIAL && text.startsWith("[")
                    ...
                    try {
                        ...
                        val a = arrayOfNulls<String>(jsonArray.length())
                        textArr = a as Array<String>
                    ...
                    val beginAlpha = (AlphaValue.MAX * java.lang.Float.parseFloat(alphaArr[0])).toInt()
